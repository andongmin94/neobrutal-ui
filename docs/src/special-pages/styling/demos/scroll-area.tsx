...
export default function ScrollAreaDemo() {
  return (
    <ScrollArea className="rounded-base h-[300px] text-main-foreground border-2 border-border bg-main p-4 shadow-shadow">
      ...
      but laugh. And once they started laughing, they couldn&apos;t stop. Jokester began sneaking
      into the castle in the middle of the night and leaving jokes all over the place: under the
      king&apos;s pillow, in his soup, even in the royal toilet. The king was furious, but he
      couldn&apos;t seem to stop Jokester. And then, one day, the people of the kingdom discovered
