              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-sm sm:text-base">
                  ...
                  <a
                    ...
                    href="https://github.com/andongmin94/neobrutal-ui/blob/main/CONTRIBUTING.md"
                  >
                    contributing.md
                  </a>{" "}
                  to get started.
        ...
        <section className="inset-0 w-full flex flex-col items-center justify-center bg-main  bg-[linear-gradient(to_right,#00000033_1px,transparent_1px),linear-gradient(to_bottom,#00000033_1px,transparent_1px)] bg-[size:70px_70px] px-5 lg:py-[200px] md:py-[150px] sm:py-[100px] py-[100px]">
          ...
          {/* <Tabs defaultValue="pnpm" className="max-w-[650px] w-full h-max">
            ...
            <TabsContent value="pnpm">
              <Pre
                __rawstring__="pnpm dlx shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">pnpm</span>
                  <span className="text-white/[0.53] ">{` dlx shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
            <TabsContent className="**:data-avatar:mb-0" value="npm">
              <Pre
                __rawstring__="npx shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">npx</span>
                  <span className="text-white/[0.53] ">{` shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
            ...
            <TabsContent value="bun">
              <Pre
                __rawstring__="bunx shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">bunx</span>
                  <span className="text-white/[0.53] ">{` --bun shadcn@latest init https://neobrutal-ui.andongmin.com/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
          </Tabs> */}
