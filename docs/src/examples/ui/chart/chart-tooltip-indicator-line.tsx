...
export const description = "Install pipeline timings with a line indicator";
...
export default function ChartTooltipIndicatorLine() {
  return (
    <Card className="bg-secondary-background text-foreground">
      <CardHeader>
        <CardTitle>Install Timing - Line</CardTitle>
        <CardDescription>A line indicator tracks the active pipeline stage.</CardDescription>
      </CardHeader>
      <CardContent>
