...
export const description = "Install pipeline timings with the default tooltip";
...
export default function ChartTooltipDefault() {
  return (
    <Card className="bg-secondary-background text-foreground">
      <CardHeader>
        <CardTitle>Install Timing - Default</CardTitle>
        <CardDescription>Cached and network work across each install stage.</CardDescription>
      </CardHeader>
      <CardContent>
