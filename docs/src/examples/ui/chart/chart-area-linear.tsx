...
export const description = "Registry installs with linear interpolation";
...
export default function ChartAreaLinear() {
  return (
    <Card className="bg-secondary-background text-foreground">
      <CardHeader>
        <CardTitle>Linear Install Progression</CardTitle>
        <CardDescription>Release-to-release installs across recent six releases</CardDescription>
      </CardHeader>
      <CardContent>
