...
export const description = "Install pipeline timings without a tooltip label";
...
export default function ChartTooltipLabelNone() {
  return (
    <Card className="bg-secondary-background text-foreground">
      <CardHeader>
        <CardTitle>Install Timing - Values Only</CardTitle>
        <CardDescription>Only timing values are shown for quick comparison.</CardDescription>
      </CardHeader>
      <CardContent>
