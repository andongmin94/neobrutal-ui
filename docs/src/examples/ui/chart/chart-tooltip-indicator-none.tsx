...
export const description = "Install pipeline timings without an indicator";
...
export default function ChartTooltipIndicatorNone() {
  return (
    <Card className="bg-secondary-background text-foreground">
      <CardHeader>
        <CardTitle>Install Timing - Minimal</CardTitle>
        <CardDescription>Pipeline values without a visual indicator.</CardDescription>
      </CardHeader>
      <CardContent>
