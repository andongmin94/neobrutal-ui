...
type CheckboxProps = Omit<CheckboxPrimitive.Root.Props, "checked" | "defaultChecked"> & {
  checked?: CheckedState;
  defaultChecked?: CheckedState;
};

function Checkbox({ checked, className, defaultChecked, indeterminate, ...props }: CheckboxProps) {
  return (
